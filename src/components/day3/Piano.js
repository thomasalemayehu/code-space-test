...
import "../../assets/day3/styles/index.css";
// import PianoImage from "../../assets/day3/images/piano.svg";
const Piano = () => {
  const audio = useMemo(() => {
    return new Audio();
  },[]);

  const playSoundOnHover = (soundItem) => {
    const audioUrl = `/assets/day3/audios/${soundItem}.mp3`;
    audio.pause();
    audio.src = audioUrl;
    audio.play();
  };
